...
$codeCheck = isset($_GET['codeCheck']) ? filter_var($_GET['codeCheck'], FILTER_VALIDATE_BOOLEAN) : false;
// if ($category['category_name'] == $program['category'] && (!$codeCheck || $program['code'] == $code))
